        ...
        <div
          ...
          >
            <div
              ...
              >
              <h2 style="font-size: 25px; display: block">Submited</h2>
              <h2
                class="text-center"
                style="font-size: 35px; display: block; font-weight: bold"
              >
              <?php echo(getInvestigatorSubmittedCaseNumber($conn, $_SESSION['users_id']));  ?>
              </h2>
            </div>
        </div>
        ...
        <div
          ...
          <div
              ...
              <h2
                class="text-center"
                style="font-size: 35px; display: block; font-weight: bold"
              ><?php echo(getInvestigatorInProgressCaseNumber($conn, $_SESSION['users_id']));  ?>
              </h2>
          </div>
        </div>
          ...
          >
            <div
              ...
              <h2
                class="text-center"
                style="font-size: 35px; display: block; font-weight: bold"
              ><?php echo(getInvestigatorCompletedCasesNumber($conn, $_SESSION['users_id']));  ?>
              </h2>
            </div>
        </div>
      </div>
      ...
      <div class="row" style="margin-top: 35px">
        <div
          ...
          <table class="table table-sm">
            ...
            <?php
            $result = getInvestigatorCases($conn, $_SESSION['users_id']);
            if($result == false){
